...
class SACReplayBuffer:
    ...
    def add(self, prev_state, prev_mf, action, reward, curr_state, curr_mf, done, agent_id=0):
...
class MultiAgentSACReplayBuffer:
    ...
    def add_batch(self, states, prev_mf, actions, rewards, curr_states,curr_mf, dones, agent_ids):
